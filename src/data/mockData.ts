...
export const mockBudgetData: CategoryGroup[] = [
  {
    ...
    name: 'Needs',
    categories: [
      { id: 'rent', name: 'Rent / Mortgage', emoji: '🏠', assigned: 0, activity: 0, available: 0 },
      { id: 'electric', name: 'Electric & Gas', emoji: '⚡', assigned: 0, activity: 0, available: 0 },
      { id: 'internet', name: 'Internet', emoji: '📡', assigned: 0, activity: 0, available: 0 },
      { id: 'groceries', name: 'Groceries', emoji: '🛒', assigned: 0, activity: 0, available: 0 },
      { id: 'transport', name: 'Transportation', emoji: '🚗', assigned: 0, activity: 0, available: 0 },
      { id: 'phone', name: 'Phone', emoji: '📱', assigned: 0, activity: 0, available: 0 },
      { id: 'insurance', name: 'Insurance', emoji: '🛡️', assigned: 0, activity: 0, available: 0 },
  ...
  },
  {
    ...
    categories: [
      ...
      { id: 'charity',  name: 'Charity',                     emoji: '❤️', assigned: 0,     activity: 0, available: 0 },
