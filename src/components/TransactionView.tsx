...
export default function TransactionView({ accountId, accounts, transactions, onTransactionsChange, onCloseAccount, onDeleteAccount, onRenameAccount, budgetGroups, gradientColors, billLinkedTxIds }: TransactionViewProps) {
